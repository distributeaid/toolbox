...
countries.forEach((country: Place) => countryCodeToNameMap.set(country.code, country.name))
...
usStates.forEach((usState: Place) => usStateCodeToNameMap.set(usState.code, usState.name))
