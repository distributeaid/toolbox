defmodule Ferry.Shipments.Shipment do
  ...
  schema "shipments" do
    field :sending_group_id, :integer
  ...
  def changeset(shipment, attrs) do
    shipment
    |> cast(attrs, [:sending_group_id, :sender_address, :items, :funding, :reciever_address, :reciever_group_id])
    |> validate_required(:sending_group_id, [message: "Cannot be Empty"])
